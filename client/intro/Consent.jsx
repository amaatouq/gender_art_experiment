      ...
      <Centered>
        <div className="consent">
          ...
          <p className="bp3-ui-text">
            ...
            purpose of this survey is to measure the characteristics that make
            an artwork “attractive.” You will be shown a series of 10 artworks.
            For each, you will be asked to describe the work, and then to
            indicate how much you would expect to value it. These are not famous
            artworks, so you will probably be seeing them for the first time.
            You may, however, recognize artist's names. Answer the questions
            purely based on your first impression.
          </p>
